...
function divMensaje(mensaje, TipoMensaje){
    ...
    +'		<div class="row center-block" style="width: 580px; margin-top: -5px; margin-left: -20px; margin-bottom: -25px;height: 32%; position: relative; ">'
	+'		    <div id="signupbox" class="mainbox col-md-12">'
	+'		        <div class="panel panel-info">'
	+'		            <div class="panel-heading" style="height: 1px">'
	+'		                <div class="panel-title titulo" style="margin-top: -10px"><div class="text-left">Mensaje del Sistema</div></div>'
	+'		            </div>'
	...
	+'			              </div>'
	+'						  <div class="col-xs-8 center_text" style="margin-bottom: 0px;">'
