...
function chromeless(u,n,W,H,X,Y,cU,cO,cL,mU,mO,xU,xO,rU,rO,tH,tW,wB,wBs,wBG,wBGs,wNS,fSO,brd,max,min,res,tsz){
	...
	min=(v>=5.5?min:false);
	var w=window.screen.width; var h=window.screen.height-50
	...
	var mensaje = "Favor usar el boton salir";
	...
	if(c){
		...
		//'var IcL=new Image();IcL.src="'+cL+'";var IxU=new Image();IxU.src="'+xU+'";var IxO=new Image();IxO.src="'+xO+'";var IrU=new Image();IrU.src="'+rU+'";var IrO=new Image();IrO.src="'+rO+'";var ImU=new Image();ImU.src="'+mU+'";var ImO=new Image();ImO.src="'+mO+'"\n'+
		...
		'wRSZ=function(){var dw=document.body.clientWidth;bCLO.style.pixelLeft=dw-22;bMIN.style.pixelLeft=bLOA.style.pixelLeft=dw-52;bFUL.style.pixelLeft=bRES.style.pixelLeft=dw-37}\n'+
		...
		'<img id=bMOV style="position:absolute;left:-50px;top:-50px" '+(max?'ondblclick="wDBL()"':'')+' onmousemove="wMOV()" onmousedown="b=1;wMOV()" onmouseup="b=0;wMOV()" border=0 src="" width=2000 height=500>\n'+
		'<img id=bFUL style="position:absolute;top:4px;left:'+(W-37)+'px;'+(max?'':'display:none')+'" src="'+xU+'" border=0 onmouseover="this.src=IxO.src" onmouseout="this.src=IxU.src" onmouseup="this.src=IxU.src" onmousedown="this.src=IxU.src" >\n'+
		'<img id=bRES style="position:absolute;top:4px;left:'+(W-37)+'px;visibility:hidden" src="'+rU+'" border=0  onmouseover="this.src=IrO.src" onmouseout="this.src=IrU.src" onmouseup="this.src=IrU.src" onmousedown="this.src=IrU.src" >\n'+
		'<img id=bCLO style="position:absolute;top:2px;left:'+(W-22)+'px;" src="'+cU+'" border=0  onmouseover="this.src=IcO.src" onmouseout="this.src=IcU.src" onmouseup="this.src=IcU.src" onmousedown="this.src=IcU.src">\n'+
		'<img id=bLOA style="position:absolute;top:4px;left:'+(W-52)+'px;" src="'+cL+'" border=0 >\n'+
		'<img id=bMIN style="position:absolute;top:4px;left:'+(W-52)+'px;visibility:hidden" src="'+mU+'" border=0  onmouseover="this.src=ImO.src" onmouseout="this.src=ImU.src" onmouseup="this.src=ImU.src" onmousedown="this.src=ImU.src" onclick="wMIN()">\n'+
		'</body>\n'+
		'</html>'
		...
		cRES=function(b,s){
			...
			'}}</script></head>\n'+
			'<body bgcolor='+wBG+'>\n'+
			'<img style="cursor:'+s+'-resize" id=bMOV style="position:absolute;left:-50px;top:-50px" onmousemove="wMOV()" onmousedown="b=1;wMOV()" onmouseup="b=0;wMOV()" border=0 src="" width=3000 height=500>\n'+
			'</body>\n'+
			'</html>'
		...
		'mTIT()\n'+
		'</script></HEAD>\n'//+
		var frams= '<frameset onselectstart="return false" onload="top.ok=1" onfocus="if (top.ok&&fT&&fT.wMAX) fT.wMAX(top.mod)" border=0 framespacing=0 frameborder=0 rows="'+tsz+',100%,'+brd+'">\n'+
		...
		'			<frameset border=1 framespacing=0 frameborder=1 rows="1,100%,1">\n'+
		...
		CWIN.moveTo(5000,0)
		CWIN.ft=true
		CWIN.document.write(cFRM+frams)
		CWIN.document.close()
	} else {
